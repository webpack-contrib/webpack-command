...
module.exports = {
  ...
  flags: {
    'resolve-alias': {
      desc: 'Setup a module alias for resolving (Example: jquery-plugin=jquery.plugin)',
      type: 'string'
    },
    'resolve-extensions': {
      desc: 'Setup extensions that should be used to resolve modules (Example: --resolve-extensions .es6,.js)',
      type: 'array'
    },
