...
module.exports = {
  apply(argv, options) {
    ...
    //   result.entry = { main: options.entry };
    // }
    //
    // if (argv.entry) {
    //   if(!result.entry.main) {
    //     result.entry = { main: '' };
    //   } else if (!Array.isArray(result.entry.main)) {
    //
    //   }
    // }
    //
    ...
    //   if (result.entry.main && !Array.isArray(result.entry.main)) {
    //     result.entry.main = [result.entry.main];
    //     result.entry.main.push(argv.entry);
    //   } else {
    //     result.entry.main = argv.entry;
    //   }
    // } else if (argv.entry) {
    //   // handle --entry file --entry file2
    //   if (Array.isArray(argv.entry)) {
    ...
    //   result.entry = Object.assign(options.entry || {}, entry);
    // }
    //
