...
module.exports = {
  ...
  flags: {
    ...
    devtool: {
      desc: 'Enable devtool for better debugging experience (Example: --devtool eval-cheap-module-source-map)',
      type: 'string'
    },
    entry: {
    ...
    'run-dev': {
      alias: 'd',
      desc: 'shortcut for --debug --devtool eval-cheap-module-source-map --output-pathinfo',
      type: 'boolean'
    },
    'run-prod': {
      alias: 'p',
      desc: 'shortcut for --optimize-minimize --define process.env.NODE_ENV="production"',
      type: 'boolean'
    },
    watch: {
      alias: 'w',
